...
const soundEffects = {
  assassinFailSound: new Audio('sounds/assassinationfail.mp3'),
  assassinWinSound: new Audio('sounds/assassinwin.mp3'),
  attackSound: new Audio('sounds/attack.mp3'),
  loseSound: new Audio('sounds/lose.mp3'),
  officeSound: new Audio('sounds/office.mp3'),
  terrorSound: new Audio('sounds/terror.mp3'),
  weaponsSound: new Audio('sounds/weapons.mp3'),
  winSound: new Audio('sounds/win.mp3'),
  // Add more sound effects as needed
};

const bgmTracks = {
  bgm1: new Audio('music/bgm1.mp3'),
  bgm2: new Audio('music/bgm2.mp3'),
  bgm3: new Audio('music/bgm3.mp3'),
};
...
function giveDonation() {
  if (checkIfCanAfford(100)) {
      img.src = 'images/giveDonation.jpg';
...
function rootOutRebels() {
  ...
  if (chanceOfRebels >= 5) {
    ...
    img.src = 'images/goodRootOut.jpg';
...
function meetPolice() {
  ...
  img.src = 'images/meetPolice.jpg';
  update(locations[3]);
  assassinationWindow();
}

function arrestMinor() {
  img.src = 'images/arrestMinor.jpg';
...
function meetBank() {
  playSoundEffect('officeSound');
  img.src = 'images/meetBank.jpg';
  update(locations[4]);
  assassinationWindow();
}

function printMoney() {
  img.src = 'images/printMoney.jpg';
...
function confiscateMoney() {
  ...
  militaryStrength -= sadBoost / 2;
  law -= sadBoost / 2;
  infoText.innerText = `You confiscate the private funds of your citizens! This will have grave consequences. Funds +${civMoneyBoost}, Democracy -${sadBoost}%, Public Order -${sadBoost}%, Military strength -${sadBoost / 2}%, Law -${sadBoost / 2}%, Rebel Strength +${sadBoost}%.`;
  updateStats();
  resetButtons();
}

function meetSecurity() {
  img.src = 'images/meetSecurity.jpg';
  update(locations[5]);
  assassinationWindow();
}
...
function assassinationAttempt() {
  ...
  if (rebelStrength + rebelPowerBoost >= personalSecurity) {
    ...
    img.src = 'images/assassinated.jpg';
    nextButtons(lose);
  } else {
